...
const Markdown = {
	...
	render : (rawBrewText, pageNumber=0)=>{
		const lastPageNumber = pageNumber > 0 && globalVarsList[pageNumber - 1] && globalVarsList[pageNumber - 1].HB_pageNumber
			? globalVarsList[pageNumber - 1].HB_pageNumber.content
			: 0;
